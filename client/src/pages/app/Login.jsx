...
function Login() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-[50%] bg-white border-r border-gray-200 flex-col justify-center items-start text-gray-800 p-12 xl:p-24 relative overflow-hidden">
