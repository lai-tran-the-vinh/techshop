  ...
  if (!isDesktop) {
    return (
      ...
      >
        ...
        >
          Website hiện chỉ hoạt động tốt nhất trên máy tính. Vui lòng truy cập
          bằng trình duyệt desktop để có trải nghiệm đầy đủ.
        </p>
        ...
        >
          ...
          >
            💻 Khuyến nghị sử dụng màn hình từ{' '}
            <strong style={{ color: '#F37021' }}>1024px</strong> trở lên
          </p>
        </div>
      </div>
    );
